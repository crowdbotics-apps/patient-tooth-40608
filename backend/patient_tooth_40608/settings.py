"""
Django settings for patient_tooth_40608 project.
...
ROOT_URLCONF = 'patient_tooth_40608.urls'
...
WSGI_APPLICATION = 'patient_tooth_40608.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_tooth_40608 API",
    "DESCRIPTION": "API documentation for patient_tooth_40608 App",
    "VERSION": "v1",
}
